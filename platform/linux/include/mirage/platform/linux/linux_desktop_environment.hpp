...
/// construction and exposes the Window / Screen / Input / Clipboard
/// providers; a failed connection (e.g. a Wayland-native session without
/// XWayland) leaves those accessors null so consumers fail closed — it never
/// silently degrades.
struct X11Options {
    bool enabled = false;
